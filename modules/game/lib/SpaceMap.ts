...
class SpaceMap {
    ...
    private backgroundBlur = new Pixi.filters.BlurFilter()
    ...
    public update = () => {
        ...
        this.background.width = this.viewport.screenWidth * 1.1
        this.background.height = this.viewport.screenHeight * 1.1
